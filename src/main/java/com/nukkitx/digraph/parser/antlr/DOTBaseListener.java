package com.nukkitx.digraph.parser.antlr;
...
public class DOTBaseListener implements DOTListener {
     ...
     */
    @Override
    public void exitAttr_stmt(@NotNull DOTParser.Attr_stmtContext ctx) {
    }
     ...
     */
    @Override
    public void exitPort(@NotNull DOTParser.PortContext ctx) {
    }
     ...
     */
    @Override
    public void exitStmt_list(@NotNull DOTParser.Stmt_listContext ctx) {
    }
     ...
     */
    @Override
    public void exitStmt(@NotNull DOTParser.StmtContext ctx) {
    }
     ...
     */
    @Override
    public void exitEdgeRHS(@NotNull DOTParser.EdgeRHSContext ctx) {
    }
     ...
     */
    @Override
    public void exitId(@NotNull DOTParser.IdContext ctx) {
    }
     ...
     */
    @Override
    public void exitA_list(@NotNull DOTParser.A_listContext ctx) {
    }
     ...
     */
    @Override
    public void exitAttr_list(@NotNull DOTParser.Attr_listContext ctx) {
    }
